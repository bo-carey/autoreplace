 ...
 */
export const waitForElementToExist = (query: string, expireTime: number = 30000): Promise<HTMLElement> => {
 ...
 * @returns {string}
 */
export const cleanText = (text: string = ""): string => text.replace(/(^\s+)|(\s+$)/gm, "");